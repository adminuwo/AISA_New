  ...
  return (
    <div className="w-full px-4 sm:px-12 pt-3 sm:pt-4 mb-4 sm:mb-8 bg-transparent">
      <div className="flex flex-col gap-4 sm:gap-6">
        ...
        {currentCase && (
          <div className="flex flex-row items-center justify-between gap-4 sm:gap-6 bg-white/50 dark:bg-zinc-900/30 p-2 sm:p-0 rounded-2xl sm:rounded-none border border-slate-100 dark:border-zinc-800/50 sm:border-none">
            <div className="flex items-center gap-2 sm:gap-5 flex-1 min-w-0">
              ...
              <div className="relative group shrink-0 hidden xs:block">
                <div className="relative p-2 sm:p-4 bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-xl sm:rounded-2xl text-white shadow-lg sm:shadow-xl shadow-indigo-500/10">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                   {isRenamingCase === currentCase._id ? (
                    ...
                    <div className="px-2 py-0.5 bg-indigo-50 dark:bg-indigo-500/10 rounded-lg border border-indigo-100 dark:border-indigo-500/20">
                      <h2 className="text-[12px] sm:text-2xl font-black text-indigo-700 dark:text-indigo-300 tracking-tight leading-tight uppercase truncate">
                        {currentCase.name}
                      </h2>
                    </div>
                  )}
            ...
            <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
                <div className="flex flex-col items-end">
                   ...
                   <AnimatePresence mode="wait">
                    <motion.div
                      ...
                      exit={{ y: -5, opacity: 0 }}
                      className="flex items-center gap-1 px-1.5 py-0.5 sm:px-4 sm:py-2 bg-slate-100 dark:bg-white/5 text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-white/10 rounded-md sm:rounded-xl"
                    >
                ...
                <div className="flex items-center gap-1 sm:gap-2">
                  <button
                    ...
                    className="p-1.5 sm:p-2.5 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-400 hover:text-indigo-600 rounded-lg sm:rounded-xl transition-all shadow-sm group"
                    title="Rename Case"
                  >
                  ...
                  <button
                    ...
                    className="p-1.5 sm:p-2.5 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-400 hover:text-red-500 rounded-lg sm:rounded-xl transition-all shadow-sm group"
                    title="Delete Case"
                  >
